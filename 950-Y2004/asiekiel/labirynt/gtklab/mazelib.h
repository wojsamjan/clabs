...
/* Liczba linii w labiryncie */
int mazeLines(void);

/* D³ugo¶æ i-tej linii */
int mazeLineLength(int i);

/* D³ugo¶æ najd³u¿szej linii */
int maxMazeWidth(void);

/* Rodzaj terenu w punkcie */
char GetTerrain(pointT pt);

/* Przywróæ labirynt do takiego stanu, w jakim znajdowa³ siê
 * bezpo¶rednio po wczytaniu */
void mazeOriginal(void);

/* Zwolnij pamiêæ u¿ywan± na aktualny labirynt */
